 ...
 */
class WorkedMDLHoursPerTicketPerAuthorCommand extends Command
{
    ...
    {
        $this
            ->setName('worked-mdl-hours-per-ticket-per-author')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        do {
            ...
            $jql = "project = MDL and worklogDate <= " . $end_time . " and worklogDate >= " . $start_time . " and timespent > 0  and timeSpent < " . rand(1000000, 9000000) . " ";
