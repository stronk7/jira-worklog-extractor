 ...
 */
class LoadMDLProjectTotalsInTimeperiodCommand extends Command
{
    ...
    {
        $this
            ->setName('load-mdl-project-totals')
            ->setDescription('Load the total time logged in a timeperiod for the MDL project')
            ->addArgument(
                'start_time',
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        do {
            ...
            $search_result = $jira->search("project = MDL and worklogDate <= " . $end_time . " and worklogDate >= " . $start_time . " and timespent > 0", $offset, self::MAX_ISSUES_PER_QUERY, "key,project");
